...
import br.com.diaslgg.domain.dao.factory.ProdutoQuantidadeFactory;
import br.com.diaslgg.domain.dao.factory.VendaFactory;
import br.com.diaslgg.domain.dao.generic.GenericDAO;
...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    private void buscarAssociacaoVendaProdutos(Connection connection, Venda venda)
        ...
        try {
            ...
            sbProd.append("P.ID AS ID_PRODUTO, P.CODIGO, P.NOME, P.DESCRICAO, P.VALOR, P.ESTOQUE ");
    ...
    @Override
    public Boolean cadastrar(Venda entity) throws TipoElementoNaoConhecidoException, DAOException {
        Connection connection = null;
        PreparedStatement stm = null;
        try {
            connection = getConnection();
